import {convertFractionsToNumber, getColumnData, townRegionCountryRegex, trimRemoveLineBreaks} from "../../helpers";
...
export abstract class BoxrecCommonTablesClass {
    ...
    get judges(): BoxrecJudge[] {
        return this.parseJudges(this.metadata);
    }
    ...
    get referee(): BoxrecBasic {
        return BoxrecCommonTablesClass.parseReferee(this.metadata);
    }
